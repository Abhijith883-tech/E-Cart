        ...
        <div className='grid grid-cols-3 gap-4 mt-5'>
          <div className='col-span-2 border rounded p-5 shadow'>
            <table className='table-auto w-full'>
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>Product Name</td>
                  <td><img width={'70px'} height={'70px'} src="https://thumbs.dreamstime.com/z/full-grocery-cart-shopping-isolated-white-background-35581745.jpg?w=576" alt="" /></td>
                  <td>
                    <div className='flex'>
            ...
            <div className='float-right mt-5'>
              <button className='bg-red-600 ms-3 rounded p-2 text-white'>Empty cart</button>
              <Link to={'/'} className='bg-blue-600 ms-3 rounded p-2 text-white'>Shop More</Link>
            </div>
          </div>
          <div className='col-span-1'>
            <div className='border rounded shadow p-5'>
              <h2 className='text-2x1 font-bold my-4'>Total Amount : <span className='text-red-600'>$ 9.99</span></h2>
              <hr />
