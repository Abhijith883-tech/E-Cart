    ...
    return (
        <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
            ...
            <ul className='flex-1 text-right'>
                {   insideHome &&
                    <li className='list-none inline-block px-5'><input onChange={(e)=> dispatch(searchProduct(e.target.value.toLowerCase()))} style={{ width: '300px', color: 'black' }} className='rounded p-2' type="text" placeholder='Search Products here...' /></li>
                }
